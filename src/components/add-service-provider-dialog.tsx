    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[480px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Fill in the details of the facility you manage. It will be submitted
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid gap-2">
            ...
            <Select
              onValueChange={(value) => setType(value as Facility["type"])}
              value={type}
            >
          ...
          <div className="grid gap-2">
            ...
            <p className="text-sm text-muted-foreground">
              You will be required to upload documents like your license and
