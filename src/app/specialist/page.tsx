...
import { getPatients } from "@/server-actions/fetch";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>
              An overview of your patients who need attention.
            </CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (
              ...
              <Table>
                ...
                <TableBody>
                  {patients.length > 0 ? (
                    patients.slice(0, 5).map((patient) => (
                      <TableRow key={patient.id}>
                        ...
                        <TableCell className="text-right text-muted-foreground">
                          {new Date(patient.last_checkup).toDateString()}
                          {" | "}
                    ...
                    <TableRow className="text-muted-foreground text-center p-5">
                      <TableCell colSpan={3}>
                        Oops! It seems you have not visited any patients yet.
                      </TableCell>
                    </TableRow>
                  )}
                </TableBody>
        ...
        <div className="space-y-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Distribution of patient statuses.
              </CardDescription>
            </CardHeader>
            <CardContent>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>
              Connect with pharmacies and clinics.
            </CardDescription>
          </CardHeader>
