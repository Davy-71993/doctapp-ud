...
//   {
//     href: "/admin/services/home-based-care",
...
const complaintsSubItems = [
  {
    href: "/admin/complaints/specialists",
    label: "Specialists",
    icon: Stethoscope,
  },
...
const bottomNavItems = [{ href: "/admin/users", label: "Users", icon: Users }];
    ...
    <Sidebar>
      ...
      <SidebarContent>
        <SidebarMenu className="gap-2 p-2">
          ...
          <Collapsible
            open={complaintsOpen}
            onOpenChange={setComplaintsOpen}
            className="w-full"
          >
            <CollapsibleTrigger asChild>
              <SidebarMenuButton
...
export default function AdminLayout({
  ...
  const getPageTitle = () => {
    ...
    if (
      pathname.startsWith("/admin/service-providers") &&
      !facilitySubItems.some((item) => item.href === pathname)
    ) {
      return "Facilities";
    }
    ...
    // if (
    //   pathname.startsWith("/admin/services") &&
    //   !servicesSubItems.some((item) => item.href === pathname)
    // ) {
    //   return "Services";
    // }
    ...
    if (
      pathname.startsWith("/admin/complaints") &&
      !complaintsSubItems.some((item) => item.href === pathname)
    ) {
      return "Complaints";
    }
