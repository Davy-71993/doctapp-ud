...
export default function SpecialistComplaintsPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Specialist Complaints</h1>
        <p className="text-muted-foreground">
          Review and manage complaints submitted about specialists.
        </p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>All Specialist Complaints</CardTitle>
        ...
        <CardContent>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead>Specialist Name</TableHead>
